...
(function($){
	...
	function Carousel(root, options){
		...
		function initialize(){
			...
			iPageSize = iPageSize < options.pageWidth ? options.pageWidth : iPageSize;
			oPages.each(function(){$(this).width(iPageSize - options.pageMargin)
			.css({'margin-right':options.pageMargin})});
