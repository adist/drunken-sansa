...
class JasperServer:
    ...
    def stop(self, process):
        '''
            adista@bizoft 101212.1137 
            used for auto killing java process which have to killed manually before
        '''
        ...
        try:
            os.kill(int(pid), 0)
            logger.info("Java Process with id %s was killed correctly." % pid)
        except: 
            logger.info("Java Process with id %s wasn't able to killed."% pid)
